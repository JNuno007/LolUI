...
public class FXMLManageInfoTournamentController implements Initializable {
    ...
    @FXML private ImageView imgMatch1BlueTeam;
    @FXML private ImageView imgMatch1RedTeam;
    @FXML private ImageView imgMatch2BlueTeam;
    @FXML private ImageView imgMatch2RedTeam;
    @FXML private ImageView imgMatch3BlueTeam;
    @FXML private ImageView imgMatch3RedTeam;
    @FXML private ImageView imgMatch4BlueTeam;
    @FXML private ImageView imgMatch4RedTeam;
    @FXML private ImageView imgMatch5BlueTeam;
    @FXML private ImageView imgMatch5RedTeam;
    @FXML private ImageView imgMatch6BlueTeam;
    @FXML private ImageView imgMatch6RedTeam;
    @FXML private ImageView imgMatch7BlueTeam;
    @FXML private ImageView imgMatch7RedTeam;
    @FXML private ImageView imgMatch8BlueTeam;
    @FXML private ImageView imgMatch8RedTeam;
    
    @FXML private Label lblMatch1BlueTeam;
    @FXML private Label lblMatch1RedTeam;
    @FXML private Label lblMatch2BlueTeam;
    @FXML private Label lblMatch2RedTeam;
    @FXML private Label lblMatch3BlueTeam;
    @FXML private Label lblMatch3RedTeam;
    @FXML private Label lblMatch4BlueTeam;
    @FXML private Label lblMatch4RedTeam;
    @FXML private Label lblMatch5BlueTeam;
    @FXML private Label lblMatch5RedTeam;
    @FXML private Label lblMatch6BlueTeam;
    @FXML private Label lblMatch6RedTeam;
    @FXML private Label lblMatch7BlueTeam;
    @FXML private Label lblMatch7RedTeam;
    @FXML private Label lblMatch8BlueTeam;
    @FXML private Label lblMatch8RedTeam;
    ...
    private List<Equipa> listaEquipasTorneioOriginal;
    
    private List<Equipa> listaEquipaSelecionados;
    ...
    public void setListas(Torneio t){
        this.listaEquipasTorneioOriginal = new ArrayList<>();
        this.listaEquipaSelecionados = new ArrayList<>();
        listaEquipasTorneioOriginal.addAll(t.getEquipatorneios());
        this.listaEquipaSelecionados = this.listaEquipasTorneioOriginal;
    }
    ...
    public void eliminaEquipas16para8(){
