...
public class FXMLTeamsMainController extends Application implements Initializable {
    ...
    @FXML private ListView listaEquipas;
    @FXML private TextField searchBar;
    
    //Imagens da Team
    @FXML private ImageView imglogoTeam;
    @FXML private ImageView imgCountry;
    
    //imagens dos Players
    @FXML private ImageView imgPlayerTop;
    @FXML private ImageView imgPlayerJungle;
    @FXML private ImageView imgPlayerMid;
    @FXML private ImageView imgPlayerADC;
    @FXML private ImageView imgPlayerSupport;
    
    //Labels da Team
    @FXML private Label lblNomeEquipa;
    @FXML private Label lblSiglaEquipa;
    @FXML private Label lblTrofeus;
    @FXML private Label lblKDA;
    
    //Labels dos Players
    @FXML private Label lblNomeTop;
    @FXML private Label lblNomeJungle;
    @FXML private Label lblNomeMid;
    @FXML private Label lblNomeADC;
    @FXML private Label lblNomeSupport;
    
    //Info Icons
    @FXML private ImageView infoTop;
    @FXML private ImageView infoJungle;
    @FXML private ImageView infoMid;
    @FXML private ImageView infoADC;
    @FXML private ImageView infoSupport;
    
    //FXML's da Tabela de Resultados de Encontros
    @FXML private TableView <Encontro> tableResultados;
    @FXML private TableColumn <Encontro, Date> dataTR;
    @FXML private TableColumn <Encontro, Encontro> blueTeamTR;
    @FXML private TableColumn <Encontro, Integer> vitoriasBlueTeamTR;
    @FXML private TableColumn <Encontro, String> vsTR;
    @FXML private TableColumn <Encontro, Integer> vitoriasRedTeamTR;
    @FXML private TableColumn <Encontro, Encontro> redTeamTR;
    @FXML private TableColumn <Encontro, String> torneioTR;
    @FXML private TableColumn <Encontro, Ronda> rondaTR;
    
    //FXML's da Tabela de Incoming Games
    @FXML private TableView <Encontro> tableIncomingGames;
    @FXML private TableColumn <Encontro, Date> dataTIG;
    @FXML private TableColumn <Encontro, Encontro> blueTeamTIG;
    @FXML private TableColumn <Encontro, String> vsTIG;
...
//        this.blueTeamTR.setCellValueFactory(c-> new SimpleStringProperty(c.getValue().getEquipaByEquipa1().getSigla()));
    ...
    @FXML public void animateImagesOnEnter(){
    ...
    @FXML public void animateImagesOnExit(){
