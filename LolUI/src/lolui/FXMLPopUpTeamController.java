...
//import model.Runaescolhida;
//import model.Spellescolhido;
...
public class FXMLPopUpTeamController implements Initializable {
    // -- LOGOS DAS EQUIPAS
    @FXML private ImageView imgLogoEquipa1;
    @FXML private ImageView imgLogoEquipa2;
    
    // -- Resultados das Equipas no Encontro
    @FXML private Label lblWinEquipa1;
    @FXML private Label lblWinEquipa2;
    
    // -- Siglas das Equipas
    @FXML private Label lblSiglaEquipa1;
    @FXML private Label lblSiglaEquipa2;
    
    // -- Nomes dos membros de equipa e posição
        //--Equipa 1
    @FXML private Label lblEquipa1NomeTop;
    @FXML private Label lblEquipa1NomeJungler;
    @FXML private Label lblEquipa1NomeMid;
    @FXML private Label lblEquipa1NomeAdc;
    @FXML private Label lblEquipa1NomeSup;
        //--Equipa 2
    @FXML private Label lblEquipa2NomeTop;
    @FXML private Label lblEquipa2NomeJungler;
    @FXML private Label lblEquipa2NomeMid;
    @FXML private Label lblEquipa2NomeAdc;
    @FXML private Label lblEquipa2NomeSup;
    
    // -- Champions dos membros de equipa 1
    @FXML private ImageView imgEquipa1TopChamp;
    @FXML private ImageView imgEquipa1JunglerChamp;
    @FXML private ImageView imgEquipa1MidChamp;
    @FXML private ImageView imgEquipa1AdcChamp;
    @FXML private ImageView imgEquipa1SupChamp;
    
    // -- Champions dos membros de equipa 2
    @FXML private ImageView imgEquipa2TopChamp;
    @FXML private ImageView imgEquipa2JunglerChamp;
    @FXML private ImageView imgEquipa2MidChamp;
    @FXML private ImageView imgEquipa2AdcChamp;
    @FXML private ImageView imgEquipa2SupChamp;
    
    // -- CS dos membros da equipa 1
    @FXML private Label lblCSEquipa1Top;
    @FXML private Label lblCSEquipa1Jungler;
    @FXML private Label lblCSEquipa1Mid;
    @FXML private Label lblCSEquipa1Adc;
    @FXML private Label lblCSEquipa1Sup;
    
    // -- CS dos membros da equipa 2
    @FXML private Label lblCSEquipa2Top;
    @FXML private Label lblCSEquipa2Jungler;
    @FXML private Label lblCSEquipa2Mid;
    @FXML private Label lblCSEquipa2Adc;
    @FXML private Label lblCSEquipa2Sup;
    
    // -- KDA dos membros da equipa 1
    @FXML private Label lblKDAEquipa1Top;
    @FXML private Label lblKDAEquipa1Jungler;
    @FXML private Label lblKDAEquipa1Mid;
    @FXML private Label lblKDAEquipa1Adc;
    @FXML private Label lblKDAEquipa1Sup;
    
    // -- KDA dos membros da equipa 2
    @FXML private Label lblKDAEquipa2Top;
    @FXML private Label lblKDAEquipa2Jungler;
    @FXML private Label lblKDAEquipa2Mid;
    @FXML private Label lblKDAEquipa2Adc;
    @FXML private Label lblKDAEquipa2Sup;
    
    // -- Spells dos membros da equipa 1
    @FXML private ImageView img1SpellEquipa1Top;
    @FXML private ImageView img2SpellEquipa1Top;
    @FXML private ImageView img1SpellEquipa1Jungler;
    @FXML private ImageView img2SpellEquipa1Jungler;
    @FXML private ImageView img1SpellEquipa1Mid;
    @FXML private ImageView img2SpellEquipa1Mid;
    @FXML private ImageView img1SpellEquipa1Adc;
    @FXML private ImageView img2SpellEquipa1Adc;
    @FXML private ImageView img1SpellEquipa1Sup;
    @FXML private ImageView img2SpellEquipa1Sup;
    
    // -- Spells dos membros da equipa 2
    @FXML private ImageView img1SpellEquipa2Top;
    @FXML private ImageView img2SpellEquipa2Top;
    @FXML private ImageView img1SpellEquipa2Jungler;
    @FXML private ImageView img2SpellEquipa2Jungler;
    @FXML private ImageView img1SpellEquipa2Mid;
    @FXML private ImageView img2SpellEquipa2Mid;
    @FXML private ImageView img1SpellEquipa2Adc;
    @FXML private ImageView img2SpellEquipa2Adc;
    @FXML private ImageView img1SpellEquipa2Sup;
    @FXML private ImageView img2SpellEquipa2Sup;
    
    // -- Builds dos membros da equipa 1
    @FXML private ImageView imgEquipa1TopItem1;
    @FXML private ImageView imgEquipa1TopItem2;
    @FXML private ImageView imgEquipa1TopItem3;
    @FXML private ImageView imgEquipa1TopItem4;
    @FXML private ImageView imgEquipa1TopItem5;
    @FXML private ImageView imgEquipa1TopItem6;
    // ----
    @FXML private ImageView imgEquipa1JunglerItem1;
    @FXML private ImageView imgEquipa1JunglerItem2;
    @FXML private ImageView imgEquipa1JunglerItem3;
    @FXML private ImageView imgEquipa1JunglerItem4;
    @FXML private ImageView imgEquipa1JunglerItem5;
    @FXML private ImageView imgEquipa1JunglerItem6;
    // ----
    @FXML private ImageView imgEquipa1MidItem1;
    @FXML private ImageView imgEquipa1MidItem2;
    @FXML private ImageView imgEquipa1MidItem3;
    @FXML private ImageView imgEquipa1MidItem4;
    @FXML private ImageView imgEquipa1MidItem5;
    @FXML private ImageView imgEquipa1MidItem6;
    // ----
    @FXML private ImageView imgEquipa1AdcItem1;
    @FXML private ImageView imgEquipa1AdcItem2;
    @FXML private ImageView imgEquipa1AdcItem3;
    @FXML private ImageView imgEquipa1AdcItem4;
    @FXML private ImageView imgEquipa1AdcItem5;
    @FXML private ImageView imgEquipa1AdcItem6;
    // ----
    @FXML private ImageView imgEquipa1SupItem1;
    @FXML private ImageView imgEquipa1SupItem2;
    @FXML private ImageView imgEquipa1SupItem3;
    @FXML private ImageView imgEquipa1SupItem4;
    @FXML private ImageView imgEquipa1SupItem5;
    @FXML private ImageView imgEquipa1SupItem6;
    
    // -- Builds dos membros da equipa 2
    @FXML private ImageView imgEquipa2TopItem1;
    @FXML private ImageView imgEquipa2TopItem2;
    @FXML private ImageView imgEquipa2TopItem3;
    @FXML private ImageView imgEquipa2TopItem4;
    @FXML private ImageView imgEquipa2TopItem5;
    @FXML private ImageView imgEquipa2TopItem6;
    // ----
    @FXML private ImageView imgEquipa2JunglerItem1;
    @FXML private ImageView imgEquipa2JunglerItem2;
    @FXML private ImageView imgEquipa2JunglerItem3;
    @FXML private ImageView imgEquipa2JunglerItem4;
    @FXML private ImageView imgEquipa2JunglerItem5;
    @FXML private ImageView imgEquipa2JunglerItem6;
    // ----
    @FXML private ImageView imgEquipa2MidItem1;
    @FXML private ImageView imgEquipa2MidItem2;
    @FXML private ImageView imgEquipa2MidItem3;
    @FXML private ImageView imgEquipa2MidItem4;
    @FXML private ImageView imgEquipa2MidItem5;
    @FXML private ImageView imgEquipa2MidItem6;
    // ----
    @FXML private ImageView imgEquipa2AdcItem1;
    @FXML private ImageView imgEquipa2AdcItem2;
    @FXML private ImageView imgEquipa2AdcItem3;
    @FXML private ImageView imgEquipa2AdcItem4;
    @FXML private ImageView imgEquipa2AdcItem5;
    @FXML private ImageView imgEquipa2AdcItem6;
    // ----
    @FXML private ImageView imgEquipa2SupItem1;
    @FXML private ImageView imgEquipa2SupItem2;
    @FXML private ImageView imgEquipa2SupItem3;
    @FXML private ImageView imgEquipa2SupItem4;
    @FXML private ImageView imgEquipa2SupItem5;
    @FXML private ImageView imgEquipa2SupItem6;
    
    // -- Botões dos Jogos
    @FXML private Button btnJogo1;
    @FXML private Button btnJogo2;
    @FXML private Button btnJogo3;
    @FXML private Button btnJogo4;
    @FXML private Button btnJogo5;
    
    // -- Runas da equipa 1
    @FXML private ImageView imgRunaEquipa1Top;
    @FXML private ImageView imgRunaEquipa1Jungler;
    @FXML private ImageView imgRunaEquipa1Mid;
    @FXML private ImageView imgRunaEquipa1Adc;
    @FXML private ImageView imgRunaEquipa1Sup;
    
    // --Runas da equipa 2
    @FXML private ImageView imgRunaEquipa2Top;
    @FXML private ImageView imgRunaEquipa2Jungler;
    @FXML private ImageView imgRunaEquipa2Mid;
    @FXML private ImageView imgRunaEquipa2Adc;
    @FXML private ImageView imgRunaEquipa2Sup;
    ...
    @FXML public void atualizaStats(MouseEvent event){
